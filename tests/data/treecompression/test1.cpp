...
void SourceStructureTree::serialize(const std::vector<FlatNodeDeDupData>& nodeList, const std::vector<uint32_t>& indexList, std::vector<char>& data, Diagnostic* dia)
{
  ...
  ret.reserve(4 + compressedIndexList.getUint32Size() + symbolListCompressed.getUint32Size() + fieldListCompressed.getUint32Size() + amountListCompressed.getUint32Size());
...
void SourceStructureTree::serialize(const std::vector<SourceStructureTreeFlat>& nodeList, const std::vector<uint32_t>& indexList, std::vector<char>& data, Diagnostic* dia)
{
  auto labeledDia = [dia](const std::string& label)
    {
      if (dia)
...
void SourceStructureTree::deserialize(const std::vector<char>& data, std::vector<SourceStructureTreeFlat>& nodeList, std::vector<uint32_t>& indexList, Diagnostic* dia)
{
  auto labeledDia = [dia](const std::string& label)
    {
      if (dia)
...
void SourceStructureTree::rebuildTree(const std::vector<SourceStructureTreeFlat>& nodeList, const std::vector<uint32_t>& indexList, std::list<SourceStructureTree*>& trees)
{
