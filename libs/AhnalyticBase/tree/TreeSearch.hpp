...
private:
protected:
  std::pair<std::string, std::string> getGitHubFile(const std::string& sourceDb, const uint32_t& fileId, const std::string& sha, std::string& licence, const EnviromentC& env);
